...
export const GridCard = ({
  ...
  const handlePress = (contentId: string) => {
    ...
    navigation.navigate('DetailNavigator', { contentId });
  };

  return (
    <TouchableOpacity style={cardStyles.card}
    onPress={() => handlePress(contentId)}
    >
      <Image source={{uri: firstimg}} style={cardStyles.image} />
      ...
      <Text style={cardStyles.description}>{address}</Text>
    </TouchableOpacity>
  );
};
